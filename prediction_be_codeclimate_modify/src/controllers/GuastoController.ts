...
import { genitoreRepository, guastoRepository } from "../middlewares/repo";
...
class GuastoController {
    ...
    static create = async (req: Request, res: Response) => {
        ...
        if (req.query.codiceGenitore) {
            ...
            await guastoRepository.save(guasto).then((bl: any) => {
                bl = encrypt(bl)
    ...
    static edit = async (req: Request, res: Response) => {
        ...
        await guastoRepository.findOneOrFail({ where: { id: idGuasto } })
            .then(async guasto => {
                guasto.data = req.body.data;
                guasto.descrizione = req.body.descrizione;
                guasto.reason = req.body.reason
                ...
                await guastoRepository.save(guasto);
    ...
    static delete = async (req: Request, res: Response) => {
        ...
        try {
            ...
            let idGuasto: any = valueToString(req.query.id);
