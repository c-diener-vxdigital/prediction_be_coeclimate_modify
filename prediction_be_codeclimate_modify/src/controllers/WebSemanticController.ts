...
class WebSemanticController {
    ...
    static create = async (req: Request, res: Response) => {
        ...
        try {
            ...
            await blacklistRepository.find().then(list => {
            ...
            const siteListItems: any = siteToAdd.map(item => blacklistRepository.create(item));


            // salvo tutti gli oggetti SiteList nel database
            await blacklistRepository.save(siteListItems).then(res => {
