...
class OperatoreController {
    ...
    static create = async (req: Request, res: Response) => {
        ...
        await operatoreRepository.save(operatore).then(bl => {
    ...
    static edit = async (req: Request, res: Response) => {
        ...
        await operatoreRepository.findOneOrFail({ where: { id: idOperatore } })
            .then(async operatore => {
                ...
                await operatoreRepository.save(operatore);
    ...
    static delete = async (req: Request, res: Response) => {
        ...
        try {
            ...
            let idOperatore: any = valueToString(req.query.id);
    ...
    static get = async (req: Request, res: Response) => {
        ...
        try {
            ...
            if (req.query.id != undefined) {
                ...
                await operatoreRepository.findOne({ where: { id: id } })
                    .then(corp => {
                        res.status(200).send(corp);
                    })

            } else {
                await operatoreRepository.find()
                    .then(corp => {
                        res.status(200).send(corp);
                    });
            }
